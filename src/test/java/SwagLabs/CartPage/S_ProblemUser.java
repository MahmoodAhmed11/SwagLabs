...
public class S_ProblemUser {

    private WebDriver driver;
    private ShopingCart shopingcart;
    private LoginDetails loginDetails;

    @BeforeTest(description = "Runs once before all tests in this class")
    public void beforeTest() {
        System.out.println("=== Starting Visual User Cart Tests ===");
    }

    @BeforeMethod(description = "Set up browser, navigate to login, and login with visual_user before each test")
    public void setup() {
